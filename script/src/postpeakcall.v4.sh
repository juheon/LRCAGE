...
Rscript /bar/jmaeng/pfiles/LRCAGE/script/src/CalcUnGRatio.v3.R $PARACLUBED $PARACLUBED".read_in_peak" $PARACLUBED".unGread_in_peak" ${PARACLUBED%.bed} $fGCAP $nGCAPtag
...
python2 /bar/jmaeng/pfiles/LRCAGE/script/src/FindSummit.v2.py ${PARACLUBED%.bed}".unG_"$fGCAP".CTSSinPeak" ${PARACLUBED%.bed}".unG_"$fGCAP".RepSummit"
